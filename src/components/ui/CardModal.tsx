      ...
      {isOpen && card && (
        <>
          ...
          <motion.div
            ...
            className="fixed right-0 top-0 bottom-0 z-[101] w-full max-w-md bg-zinc-950 border-l border-white/10 shadow-2xl overflow-y-auto"
          >
            {/* Header */}
            <div className="sticky top-0 z-10 flex items-center justify-between p-4 bg-zinc-950/90 backdrop-blur-sm border-b border-white/5">
