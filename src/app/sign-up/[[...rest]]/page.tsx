  ...
  return (
    <div className="min-h-screen bg-[#080808] flex items-center justify-center relative overflow-hidden">
      ...
      >
        ...
        {/* Glass Panel */}
        <div className="rounded-3xl border border-white/10 bg-white/[0.03] backdrop-blur-xl p-8 shadow-2xl overflow-visible">
          <h1 className="text-2xl font-bold text-white text-center mb-2">
            Únete al club
          </h1>
          <p className="text-zinc-400 text-center text-sm mb-6">
            Crea tu cuenta y comienza tu colección de cartas
          </p>
